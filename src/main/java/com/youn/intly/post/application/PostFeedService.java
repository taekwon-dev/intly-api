...
import com.youn.intly.comment.repository.CommentRepository;
...
import com.youn.intly.post.repository.PostFeedRepository;
import com.youn.intly.post.repository.PostRepository;
...
public class PostFeedService {
    ...
    private PostResponse createPostResponse(final Post post, final User requestUser) {
        return PostResponse.builder()
                ...
                .liked(isLikedBy(post, requestUser))
                .likesCount(post.getLikeCount())
                .commentsCount(countCommentsByPost(post))
                .createdAt(post.getCreatedAt())
                .updatedAt(post.getUpdatedAt())
                .build();
    }
    ...
    private int countCommentsByPost(final Post post) {
